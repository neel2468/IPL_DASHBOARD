...
public class MatchInput {
    ...
    private String city;
    private String date;
    private String player_of_matchvenue;
    ...
    public String getPlayer_of_matchvenue() {
        return player_of_matchvenue;
    }
    public void setPlayer_of_matchvenue(String player_of_matchvenue) {
        this.player_of_matchvenue = player_of_matchvenue;
    }
